...
const AdminLayout = () => {
  ...
  // Si el contexto de auth no está disponible por alguna razón, evitamos romper y consideramos que no es admin
          ...
          <header className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-2xl font-bold text-gray-800">
                Bienvenido, {(userInfo.fullName || authUser?.name) || 'Admin'}
              </h1>
